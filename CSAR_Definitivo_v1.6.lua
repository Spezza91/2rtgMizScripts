...
---------------RED----------------------------------------
    ...
    "FARP AIR DEFENCE UH1H RED #1",
    "FARP AIR DEFENCE UH1H RED #2",
    "FARP AIRDEFENCE KA50 RED #1",
    "FARP AIRDEFENCE KA50 RED #2",
    "FARP AIRDEFENCE MI8 RED #1",
    "FARP AIRDEFENCE MI8 RED #2",
    "FIGHTER MIG21 RENE RED #1",
    "FIGHTER MIG21 RENE RED #2",
    "FIGHTER MIG21 RENE RED #3",
    "FIGHTER BEIRUT MIG21 RED #1",
	"FIGHTER BEIRUT MIG21 RED #2",
	"FIGHTER BEIRUT MIG21 RED #3",
	"FIGHTER BEIRUT MIG21 RED #4",
	"FIGHTER MIG21 DAMASCO RED #1",
	"FIGHTER MIG21 DAMASCO RED #2",
	"FIGHTER MIG21 DAMASCO RED #3",
	"FIGHTER MIG21 DAMASCO RED #4",
	"FIGHTER MIG21 AIR COLLEGE RED #1",
	"FIGHTER MIG21 AIR COLLEGE RED #2",
	"FIGHTER MIG21 AIR COLLEGE RED #3",
	"FIGHTER RAMAT MIG21 RED #1",
	"FIGHTER RAMAT MIG21 RED #2",
	"FIGHTER HAIFA MIG21 RED #1",
	"FIGHTER HAIFA MIG21 RED #2",
	"FIGHTER HAIFA MIG21 RED #3",
	"FIGHTER HAIFA MIG21 RED #4",
	 
	 "FARP AIRBURBERY KA50 RED #1",
   "FARP AIRBURBERY KA50 RED #2",
	 "FARP AIRBURBERY MI8 RED #1",
   "FARP AIRBURBERY MI8 RED #2",
	 "FARP AIRBURBERY UH1H RED #1",
   "FARP AIRBURBERY UH1H RED #2",
   
   "FARP AIRNASSIRIA KA50 RED #1",
   "FARP AIRNASSIRIA KA50 RED #2",
   "FARP AIRNASSIRIA MI8 RED #1",
   "FARP AIRNASSIRIA MI8 RED #2",
   "FARP AIRNASSIRIA UH1H RED #1",
   "FARP AIRNASSIRIA UH1H RED #2",
  
   "FARP AIRRAYAK KA50 RED #1",
   "FARP AIRRAYAK KA50 RED #2",
   "FARP AIRRAYAK MI8 RED #1",
   "FARP AIRRAYAK MI8 RED #2",
   "FARP AIRRAYAK UH1H RED #1",
   "FARP AIRRAYAK UH1H RED #2",
   
   "FARP AIRCU51 KA50 RED #1",
   "FARP AIRCU51 KA50 RED #2",
   "FARP AIRCU51 MI8 RED #1",
   "FARP AIRCU51 MI8 RED #2",
   "FARP AIRCU51 UH1H RED #1",
   "FARP AIRCU51 UH1H RED #2",
   
    "FARP AIRPALMYRA KA50 RED #1",
    "FARP AIRPALMYRA KA50 RED #2",
    "FARP AIRPALMYRA MI8 RED #1",
    "FARP AIRPALMYRA MI8 RED #2",
    "FARP AIRPALMYRA UH1H RED #1",
    "FARP AIRPALMYRA UH1H RED #2",
    
    "FARP AIRRENE KA50 RED #1",
    "FARP AIRRENE KA50 RED #2",
    "FARP AIRRENE MI8 RED #1",
    "FARP AIRRENE MI8 RED #2",
    "FARP AIRRENE UH1H RED #1",
    "FARP AIRRENE UH1H RED #2",
    
    "FARP AIRBEIRUT KA50 RED #1",
    "FARP AIRBEIRUT KA50 RED #2",
    "FARP AIRBEIRUT MI8 RED #1",
    "FARP AIRBEIRUT MI8 RED #2",
    "FARP AIRBEIRUT UH1H RED #1",
    "FARP AIRBEIRUT UH1H RED #2",
    
    "FARP AIRWUJAH KA50 RED #1",
    "FARP AIRWUJAH KA50 RED #2",
    "FARP AIRWUJAH MI8 RED #1",
    "FARP AIRWUJAH MI8 RED #2",
    "FARP AIRWUJAH UH1H RED #1",
    "FARP AIRWUJAH UH1H RED #2",
    
    "FARP AIRDAMASCO KA50 RED #1",
    "FARP AIRDAMASCO KA50 RED #2",
    "FARP AIRDAMASCO MI8 RED #1",
    "FARP AIRDAMASCO MI8 RED #2",
    "FARP AIRDAMASCO UH1H RED #1",
    "FARP AIRDAMASCO UH1H RED #2",
    
    "FARP AIRKIRYAT KA50 RED #1",
    "FARP AIRKIRYAT KA50 RED #2",
    "FARP AIRKIRYAT MI8 RED #1",
    "FARP AIRKIRYAT MI8 RED #2",
    "FARP AIRKIRYAT UH1H RED #1",
    "FARP AIRKIRYAT UH1H RED #2",
    
    "FARP AIRBEIT KA50 RED #1",
    "FARP AIRBEIT KA50 RED #2",
    "FARP AIRBEIT MI8 RED #1",
    "FARP AIRBEIT MI8 RED #2",
    "FARP AIRBEIT UH1H RED #1",
    "FARP AIRBEIT UH1H RED #2",
    
    "FARP AIRWESTERN KA50 RED #1",
    "FARP AIRWESTERN KA50 RED #2",
    "FARP AIRWESTERN MI8 RED #1",
    "FARP AIRWESTERN MI8 RED #2",
    "FARP AIRWESTERN UH1H RED #1",
    "FARP AIRWESTERN UH1H RED #2",
    
    "FARP AIRKING KA50 RED #1",
    "FARP AIRKING KA50 RED #2",
    "FARP AIRKING MI8 RED #1",
    "FARP AIRKING MI8 RED #2",
    "FARP AIRKING UH1H RED #1",
    "FARP AIRKING UH1H RED #2",
   
   
---------------BLUE----------------------------------------
--
--
    "FARP AIRDEFENCE MI8 BLUE #1",
    "FARP AIRDEFENCE MI8 BLUE #2",
    "FARP AIR DEFENCE KA50 BLUE #1",
    "FARP AIR DEFENCE KA50 BLUE #2",
    "FARP AIR DEFENCE UH1H BLUE #1",
    "FARP AIR DEFENCE UH1H BLUE #2",
    "FIGHTER F5 BEIRUT BLU #1",
    "FIGHTER F5 BEIRUT BLU #2",
    "FIGHTER F5 BEIRUT BLU #3",
    "FIGHTER F5 BEIRUT BLU #4",
  	"FIGHTER DAMASCO F5 BLU #1",
    "FIGHTER DAMASCO F5 BLU #2",
    "FIGHTER DAMASCO F5 BLU #3",
    "FIGHTER DAMASCO F5 BLU #4",
	  "FIGHTER AIR COLLEGE F5 BLU #1",
    "FIGHTER AIR COLLEGE F5 BLU #2",
    "FIGHTER AIR COLLEGE F5 BLU #3",
    "FIGHTER AIR COLLEGE F5 BLU #4",
	  "FIGHTER RAMAT F5 BLUE #1",
    "FIGHTER RAMAT F5 BLUE #2",
	  "FIGHTER HAIFA F5 BLUE #1",
    "FIGHTER HAIFA F5 BLUE #2",
    "FIGHTER HAIFA F5 BLUE #3",
    "FIGHTER HAIFA F5 BLUE #4",
	  
	  "FARP AIRBURBERY KA50 BLUE #1",
    "FARP AIRBURBERY KA50 BLUE #2",
	  "FARP AIRBURBERY MI8 BLUE #1",
    "FARP AIRBURBERY MI8 BLUE #2",
	  "FARP AIRBURBERY UH1H BLUE #1",
    "FARP AIRBURBERY UH1H BLUE #2",
   
    "FARP AIRNASSIRIA KA50 BLUE #1",
    "FARP AIRNASSIRIA KA50 BLUE #2",
    "FARP AIRNASSIRIA MI8 BLUE #1",
    "FARP AIRNASSIRIA MI8 BLUE #2",
    "FARP AIRNASSIRIA UH1H BLUE #1",
    "FARP AIRNASSIRIA UH1H BLUE #2",
   
    "FARP AIRRAYAK KA50 BLUE #1",
    "FARP AIRRAYAK KA50 BLUE #2",
    "FARP AIRRAYAK MI8 BLUE #1",
    "FARP AIRRAYAK MI8 BLUE #2",
    "FARP AIRRAYAK UH1H BLUE #1",
    "FARP AIRRAYAK UH1H BLUE #2",
   
    "FARP AIRCU51 KA50 BLUE #1",
    "FARP AIRCU51 KA50 BLUE #2",
    "FARP AIRCU51 MI8 BLUE #1",
    "FARP AIRCU51 MI8 BLUE #2",
    "FARP AIRCU51 UH1H BLUE #1",
    "FARP AIRCU51 UH1H BLUE #2",
    
    "FARP AIRPALMYRA KA50 BLUE #1",
    "FARP AIRPALMYRA KA50 BLUE #2",
    "FARP AIRPALMYRA MI8 BLUE #1",
    "FARP AIRPALMYRA MI8 BLUE #2",
    "FARP AIRPALMYRA UH1H BLUE #1",
    "FARP AIRPALMYRA UH1H BLUE #2",
    
    "FARP AIRRENE KA50 BLUE #1",
    "FARP AIRRENE KA50 BLUE #2",
    "FARP AIRRENE MI8 BLUE #1",
    "FARP AIRRENE MI8 BLUE #2",
    "FARP AIRRENE UH1H BLUE #1",
    "FARP AIRRENE UH1H BLUE #2",
    
    "FARP AIRBEIRUT KA50 BLUE #1",
    "FARP AIRBEIRUT KA50 BLUE #2",
    "FARP AIRBEIRUT MI8 BLUE #1",
    "FARP AIRBEIRUT MI8 BLUE #2",
    "FARP AIRBEIRUT UH1H BLUE #1",
    "FARP AIRBEIRUT UH1H BLUE #2",
    
    "FARP AIRWUJAH KA50 BLUE #1",
    "FARP AIRWUJAH KA50 BLUE #2",
    "FARP AIRWUJAH MI8 BLUE #1",
    "FARP AIRWUJAH MI8 BLUE #2",
    "FARP AIRWUJAH UH1H BLUE #1",
    "FARP AIRWUJAH UH1H BLUE #2",
    
    "FARP AIRDAMASCO KA50 BLUE #1",
    "FARP AIRDAMASCO KA50 BLUE #2",
    "FARP AIRDAMASCO MI8 BLUE #1",
    "FARP AIRDAMASCO MI8 BLUE #2",
    "FARP AIRDAMASCO UH1H BLUE #1",
    "FARP AIRDAMASCO UH1H BLUE #2",
    
    "FARP AIRKIRYAT KA50 BLUE #1",
    "FARP AIRKIRYAT KA50 BLUE #2",
    "FARP AIRKIRYAT MI8 BLUE #1",
    "FARP AIRKIRYAT MI8 BLUE #2",
    "FARP AIRKIRYAT UH1H BLUE #1",
    "FARP AIRKIRYAT UH1H BLUE #2",
    
    "FARP AIRBEIT KA50 BLUE #1",
    "FARP AIRBEIT KA50 BLUE #2",
    "FARP AIRBEIT MI8 BLUE #1",
    "FARP AIRBEIT MI8 BLUE #2",
    "FARP AIRBEIT UH1H BLUE #1",
    "FARP AIRBEIT UH1H BLUE #2",
    
    "FARP AIRWESTERN KA50 BLUE #1",
    "FARP AIRWESTERN KA50 BLUE #2",
    "FARP AIRWESTERN MI8 BLUE #1",
    "FARP AIRWESTERN MI8 BLUE #2",
    "FARP AIRWESTERN UH1H BLUE #1",
    "FARP AIRWESTERN UH1H BLUE #2",
    
    "FARP AIRKING KA50 BLUE #1",
    "FARP AIRKING KA50 BLUE #2",
    "FARP AIRKING MI8 BLUE #1",
    "FARP AIRKING MI8 BLUE #2",
    "FARP AIRKING UH1H BLUE #1",
    "FARP AIRKING UH1H BLUE #2",

    "FARP AIRNAVAL UH1H BLUE #1",
    "FARP AIRNAVAL UH1H BLUE #2",
    "FARP AIRNAVAL UH1H BLUE #3",
    "helicargo24",
    "helicargo25",
...
function csar.eventHandler:onEvent(_event)
    local status, err = pcall(function(_event)
        ...
        elseif world.event.S_EVENT_EJECTION == _event.id then
			...
			env.info("############### PASSATO CHECK AI, getPlayerName: ".._unit:getPlayerName() )
			env.info("############### PASSATO CHECK AI, getName: ".._unit:getName() )
			env.info("############### PASSATO CHECK AI, getTypeName: ".._unit:getTypeName() )
			env.info("############### PASSATO CHECK AI, getCoalition: ".._unit:getCoalition() )
			env.info("############### PASSATO CHECK AI, getID: ".._unit:getID() )
			
			if string.match(_unit:getTypeName(), "F-14") then
				env.info("GESTIONE MULTI CREW")

				if csar.multiCrewCounter[_unit:getPlayerName()] == nil or csar.multiCrewCounter[_unit:getPlayerName()] == 0 then
					env.info("EVENTO PER PLAYER ".._unit:getPlayerName().." NON ANCORA GESTITO")
					csar.multiCrewCounter[_unit:getPlayerName()] = 1
				else
					env.info("EVENTO PER PLAYER ".._unit:getPlayerName().." GIA' GESTITO")
					csar.multiCrewCounter[_unit:getPlayerName()] = 0
					return
				end
			end
...
function csar.handleEjectOrCrash(_unit,_crashed)
	...
	----------------INIZIO MOD-----------------------
			if string.match(_unit:getName(), "FARP AIR") or string.match(_unit:getName(), "FIGHTER") then
				csar.pilotLives[_unit:getPlayerName()] = _lives - 0
				--csar.pilotLives[_unit:getPlayerName()] = _lives = 4
				env.info("handleEjectOrCrash -- > UNIT INFO: ".._unit:getPlayerName())
			else ----------------FINE MOD-----------------------
...
function csar.checkDisabledAircraftStatus(_args)
    ...
    if _unit ~= nil and _unit:getPlayerName() ~= nil and _playerName == _unit:getPlayerName() then
		...
		if string.match(_unit:getName(), "FARP AIR") or string.match(_unit:getName(), "FIGHTER") then
			csar.displayMessageToSAR(_unit,_text, 0,false)-----NON FACCIO NIENTE
		else	
...
--------MOD 20210209 PER NON FAR ESPLODERE IN ARIA I VELIVOLI INDICATI---------------
if string.match(_unit:getName(), "FARP AIR") or string.match(_unit:getName(), "FIGHTER") then
	return false	-----NON FACCIO NIENTE
else	
